...
int solution(vector<int> diffs, vector<int> times, long long limit) {
    ...
    while (true)
    {
        ...
        for (int Count = 0; Count < n; Count++)
        {
            ...
            {
                SpentTime += ((time + times[Count - 1]) * (diff - Level) + time);
            }
        }
...
실행 결과 〉	테스트를 통과하였습니다.
테스트 2
입력값 〉[1, 4, 4, 2], [6, 3, 8, 2], 59
기댓값 〉	2
실행 결과 〉	실행한 결괏값 3이 기댓값 2과 다릅니다.
테스트 3
입력값 〉[1, 328, 467, 209, 54], [2, 7, 1, 4, 3], 1723
기댓값 〉	294
실행 결과 〉	실행한 결괏값 234이 기댓값 294과 다릅니다.
테스트 4
입력값 〉[1, 99999, 100000, 99995], [9999, 9001, 9999, 9001], 3456789012
기댓값 〉	39354
실행 결과 〉	실행한 결괏값 50001이 기댓값 39354과 다릅니다.
테스트 결과(~˘▾˘)~
4개 중 1개 성공
종료까지
00:21 : 58